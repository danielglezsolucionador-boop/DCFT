...
async def health() -> dict:
    ...
    return {
        ...
        "modules": {
            ...
            "sunat_readonly": "enabled" if settings.sunat_readonly_enabled else "disabled",
            "sunat_api_automation": "enabled" if settings.sunat_api_automation_enabled else "disabled",
            "sunat_sensitive_actions": "blocked",
            "database": db["status"],
        },
        "database": db,
